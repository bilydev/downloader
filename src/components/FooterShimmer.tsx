  ...
  return (
    <footer className="w-full mt-16 border-t border-purple-900/30 bg-gradient-to-b from-[#07070b] via-[#0b0b14] to-[#050508] py-10 px-4 text-center select-none">
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        <p className="text-xs text-purple-200/80 max-w-xl mx-auto leading-relaxed font-medium">
          bily downloader kami di sini banyak keunggulan dari mulai mendownload kebutuhan anda untuk mendownload video orang lain dengan cepat dan hd terimakasih telah menggunakan website dari bily yah
        </p>
